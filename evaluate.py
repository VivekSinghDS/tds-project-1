...
async def a8(email, **kwargs):
    ...
    print('this is the result ', result, data['number'])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--email", default="23ds1000005@ds.study.iitm.ac.in", help="Set the email address")
